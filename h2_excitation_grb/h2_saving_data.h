...
void save_electron_spectrum_evolution(const std::string& output_path, const std::vector<double>& electron_energies_grid, const std::vector<double>& electron_energy_bin_size, 
    const std::vector<double>& time_moments, const std::vector<dynamic_array>& spectrum_data, double grb_distance, double conc_h_tot);
...
void save_specimen_conc_evolution(const std::string& output_path, const std::vector<double>& time_moments,
    const std::vector<dynamic_array>& conc_data, double grb_distance, double conc_h_tot);
...
void save_h2_populations_evolution(const std::string& output_path, const std::vector<double>& time_moments,
    const std::vector<dynamic_array>& h2_popdens_data, const std::vector<dynamic_array>& h2_popdens_v_data, double grb_distance, double conc_h_tot, int nb_lev_h2);
...
void save_hei_populations_evolution(const std::string& output_path, const std::vector<double>& time_moments,
    const std::vector<dynamic_array>& hei_popdens_data, double grb_distance, double conc_h_tot, int nb_lev_hei);

void save_electron_energy_loss_rates(const std::string& output_path, double grb_distance, double conc_h_tot, const std::vector<double>& time_moments,
    ...
    const std::vector<double>& enloss_rates_h2_electr_sin,
    const std::vector<double>& enloss_rates_h2_electr_tri,
...
void save_electron_energy_losses(const std::string& output_path, double grb_distance, double conc_h_tot, const std::vector<double>& time_moments,
...
void save_diss_excit_data(const std::string& output_path, const std::vector<double>& time_moments, 
    ...
    const std::vector<double>& h2_diss_exc_triplet_arr, const std::vector<double>& hei_exc_arr, double grb_distance, double conc_h_tot);
